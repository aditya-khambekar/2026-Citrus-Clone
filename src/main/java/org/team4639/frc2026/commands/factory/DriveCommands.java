...
public class DriveCommands {
    ...
    public static Command autoScoringAlign(
            Drive drive
    ) {
        return drive.run(() -> {
            runSOTM(drive, new Translation2d());
        });
    }
    ...
    public static double getSOTMOmegaOutput(Drive drive) {
        ...
        return (Math.abs(anglePID.getError()) < Units.degreesToRadians(15)
    ...
    private static void runSOTM(Drive drive, Translation2d fieldRelativeLinearVelocity) {
        ...
        double omegaOutput = getSOTMOmegaOutput(drive);
